...
It is recommended to install the appropriate release branch for your version of MediaWiki. It is not recommended to install the master branch. It is not currently recommended to install this branch.
